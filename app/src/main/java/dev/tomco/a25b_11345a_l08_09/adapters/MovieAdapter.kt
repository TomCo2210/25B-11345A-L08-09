package dev.tomco.a25b_11345a_l08_09.adapters

import android.animation.ObjectAnimator
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import dev.tomco.a25b_11345a_l08_09.R
import dev.tomco.a25b_11345a_l08_09.databinding.MovieItemBinding
import dev.tomco.a25b_11345a_l08_09.interfaces.MovieCallback
import dev.tomco.a25b_11345a_l08_09.models.Movie
import dev.tomco.a25b_11345a_l08_09.utilities.Constants
import dev.tomco.a25b_11345a_l08_09.utilities.ImageLoader
import dev.tomco.a25b_11345a_l08_09.utilities.TimeFormatter
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        with(holder) {
            with(getItem(position)) {
                ...
                binding.movieLBLDuration.text = TimeFormatter.formatTime(duration)
    ...
    inner class MovieViewHolder(val binding: MovieItemBinding) :
        ...
        init {
            binding.movieIMGFavorite.setOnClickListener {
                movieCallback?.favoriteIconClicked(
